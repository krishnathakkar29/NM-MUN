            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">
                  Model United Nations or MUN is an educational simulation of
                  the United Nations where students act as delegates
                  representing different countries. Participants engage in
                  debates and negotiations on global issues, working to draft
                  resolutions that reflect international diplomacy and
                  cooperation. NMCMUN is the Model United Nations Club at NM
                  College, established with the goal of fostering an
                  understanding of global issues, diplomacy, and international
                  relations among students. The club provides a platform for
                  students to cultivate essential skills such as public
                  speaking, negotiation and research while engaging in debates
                  that stimulate real world diplomatic scenarios
                </p>
              </div>
            </div>
          </div>
