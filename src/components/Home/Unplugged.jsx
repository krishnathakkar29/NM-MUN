...
const DummyContent = () => {
  return (
    <img
      src="/highlight.webp"
      alt="dummy image"
      className="object-cover  w-[35rem] h-full absolute inset-0 rounded-xl"
    ...
    content: (
      <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white ">
        ...
        <img
          ...
          alt="dummy image"
          className="object-cover w-[35rem] md:w-full md:h-full absolute inset-0 rounded-xl"
        />
      </div>
    ),
  },
...
function Unplugged() {
  return (
    <div className=" bg-[#0d0d0d] pt-16 pb-4 md:pb-24">
      <div className="text-center">
        <h1 className="text-5xl text-white mb-4">NMCMUN Unplugged</h1>
